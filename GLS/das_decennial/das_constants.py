...
Attempting to assign to CC.CONSTANT will raise an error.
...
class _DAS_CONSTANTS:
    ...
    STRATEGY = "strategy"
    BUN_STEINKE = "bun_steinke_eps_delta_conversion"

    ## DP mechanism noise primitives
    PRIMITIVE_FRACTION_DENOM_LIMIT = 1048576
    DENOM_MAX_POWER = np.ceil(np.log2(PRIMITIVE_FRACTION_DENOM_LIMIT) / 2)
    ...
    DAS_RUN_TYPE_ENV  = 'DAS_RUN_TYPE'
    DAS_TIER_ENV      = 'DAS_TIER'
    DAS_CLOUD_ENV     = 'DAS_CLOUD'
    ITE               = "ITE"
    DAS_S3INPUTS_ENV  = 'DAS_S3INPUTS'
    ...
    GEOLEVEL_NUM_PART = "geolevel_num_part"
    PART_SIZE_NOISY = "part_size_noisy"
    PART_SIZE_BLOCK = "part_size_block"
    PART_SIZE_OPTIMIZED = "part_size_optimized"
    PART_SIZE_OPTIMIZED_BLOCK = "part_size_optimized_block"
    AGGREGATE_TO_COUNTY = "aggregate_to_county"
    ...
    L2_OLS_PREPASS = "L2 OLS pre-pass"
    ...
    POSTPROCESSED_NODES_POSTFIX = "postprocessed_nodes_postfix"
    APPID_NO_SPARK = "APPID_No_Spark"
    AGGREGATED_CHECKPOINT = "aggregated_checkpoint"
    SKIP_PERSISTS_IN_ENGINE = "skip_persists_in_engine"
    ...
    BARCONVTOL_FOR_OPT_TOL = 'BarConvTol_for_opt_tol'
    ...
    USE_POSTPROCESS_HEURISTICS = "use_postprocess_heuristics"
    POSTPROCESS_ONLY_CONSTR_NAMES = "postprocess_only_constr_names"
    CONDITIONAL_CONSTR_NAMES = "conditional_constr_names"
    REQUIRE_FEASIBLE_SECONDARY_DIM = "require_feasible_secondary_dim"
    REQUIRE_FEASIBLE_POSTPROC_DIM = "require_feasible_postproc_dim"

    OPTIMIZER = 'optimizer'
    TEST_HIST_DECOMP = 'test_hist_decomp'
    SKIP_DECOMP = 'skip_decomp'
    ...
    L2_PLUS_ROUNDER = "L2PlusRounder"                             # The option possible values
    L2_PLUS_ROUNDER_INTERLEAVED = "L2PlusRounder_interleaved"     # The option possible values
    ...
    DATA_IND_USER_SPECIFIED_QUERY_NPASS_DECOMP = 'DataIndUserSpecifiedQueriesNPassDecomp'
    ...
    MULTIPASS_ROUNDER_DECOMP = 'MultipassRounderDecomp'
    ...
    DAS_AIAN_AREAS_CNSTAT = ("Legal_Federally_Recognized_American_Indian_Area", "American_Indian_Joint_Use_Area", "Hawaiian_Home_Land", "Alaska_Native_Village_Statistical_Area", "State_Recognized_Legal_American_Indian_Area", "Oklahoma_Tribal_Statistical_Area", "Joint_Use_Oklahoma_Tribal_Statistical_Area")
    AIAN_RANGES_PATH_DEFAULT = os.path.realpath('programs/geographic_spines/AIANNHCE_ranges.csv')
    STRONG_MCD_STATES_DEFAULT = ('09', '23', '25', '26', '27', '33', '34', '36', '42', '44', '50', '55')
    OPT_SPINE = "opt_spine"
    AIAN_SPINE = "aian_spine"
    NON_AIAN_SPINE = "non_aian_spine"
    PRIM_SPINE = "prim_spine"
    ...
    TARGET_SCHOOL_DISTS = "target_school_dists"

    ADDITIONAL_LEVELS = ("Prim", "OSE", "Place", "MCD", "PEP_MCD", "SchoolDist", "AIAN_AREAS", "FED_AIRS")
    ...
    STATES_AND_NONINCORPORATED_PLACE_CODES_INCLUDED_IN_OFFICIAL_PRIM_DEFINITION = (('22', '36255'), ('11', '50000'), ('15', '71550'), ('20', '71450'))
    PLACEFS_CODES_FOR_PRIMS = ("A", "B", "F")
    COUSUBFS_CODES_FOR_PRIMS = ("A", "B", "C")

    TG_OPT_TUPLE = "TG_opt_tuple"
    BG_OPT_STR = "BG_opt_str"
    ## Geolevel names:
    GEOLEVEL_TRACT = "Tract"
    GEOLEVEL_BLOCK = "Block"
    GEOLEVEL_BLOCK_GROUP = "Block_Group"
    GEOLEVEL_TRACT_GROUP = "Tract_Group"
    GEOLEVEL_COUNTY = "County"
    GEOLEVEL_STATE = "State"
    GEOLEVEL_US = "US"
    GEOLEVEL_USPR = "US+PR"
    GEOLEVEL_TRACT_SUBSET = "Tract_Subset"
    GEOLEVEL_TRACT_SUBSET_GROUP = "Tract_Subset_Group"
    GEOLEVEL_PRIM = "Prim"
    INPUT_GEOGRAPHY_GEOCODE_DICT_NAME = "input_geography_geocode_dict_name"
    GRFC_ATTRS = "grfc_attrs"
    GRFC_ATTR_WIDTHS = "grfc_attr_widths"
    GRFC_ATTR_NAMES = "grfc_attr_names"
    TABULATION_GEODICT = "tabulation_geography_geodict"
    CURRENT_GEOGRAPHY_GEODICT = "current_geography_geodict"
    SPECIAL_CENSUS_GEODICT = "special_census_geodict"
    IO_GEODICT = "io_geodict"
    WRITER_GEODICT = "writer_geodict"
    WRITER_GEOCODE = "writer_geocode"
    INPUT_GEODICT = "input_geodict"
    AFTER_READ_FILTER_GEOIDS = "after_read_filter_geoids"
    SKIP_READER_PLB_CHECK="skip_reader_plb_check"
    ...
    DEV_RUN_TYPE = 'dev'
    PROD_RUN_TYPE = 'prod'
    # BUG: These strings are using both $ refs and {ref} refs. Is that okay.
    ...
    MDF_PARTITIONS_FOR_S3CAT = 100
    MULTIWRITER_WRITERS = "multiwriter_writers"
    MAX_S3_PATH_LEN = 2048
    MAX_SAVED_S3_FILES_PER_GEOLEVEL = 50
    DAS_S3_LOGFILE_TEMPLATE = "{DAS_S3LOGS}/{CLUSTERID}/DAS/das2020logs/{fname}"
    ...
    SCHEMA_UNIT_TABLE_10_TENVACSGQ = "UNIT_TABLE_10_SCHEMA_TENVACSGQ"
    SCHEMA_UNIT_TABLE_10_TENVACSGQ_TEN_3LEV = "UNIT_TABLE_10_SCHEMA_TENVACSGQ_TEN_3LEV"
    SCHEMA_UNIT_TABLE_10_VACSGQ = "UNIT_TABLE_10_SCHEMA_VACSGQ"
    ...
    SCHEMA_UNIT_TABLE_10_CUSTOM_ESTS_AND_PROJECTIONS_AREA = "UNIT_TABLE_10_CUSTOM_EP_SCHEMA"
    SCHEMA_DHCP = "DHCP_SCHEMA"
    SCHEMA_DHCH = "DHCH_SCHEMA"
    SCHEMA_CUSTOM_ESTS_AND_PROJECTIONS_AREA = "custom_ests_and_projections_area_schema"
    SCHEMA_DHCH_TEN_3LEV = "DHCH_SCHEMA_TEN_3LEV"
    SCHEMA_DHCH_FULLTENURE = "DHCH_SCHEMA_FULLTENURE"
    ...
    # DHCP
    ATTR_HHGQ = "hhgq"
    ATTR_HHGQ_EP = "hhgq_ep"
    ATTR_SEX = "sex"
    ATTR_VOTING = "votingage"
    ATTR_HISP = "hispanic"
    ATTR_CENRACE = "cenrace"
    ATTR_RACE2010 = "race2010"
    ...
    ATTR_HHTENSHORT_3LEV = "hhtenshort_3lev"
    ...
    ATTR_TENVACGQ_TEN_3LEV = "tenvacgq_ten_3lev"
    ...
    ATTR_HHGQ_EP_UNIT = "hhgq_ep_unit"
    ...
    RELGQ_4_GROUPS = "relgq_4_groups"
    POPSEHSDTARGETS_RELSHIP = "popSehsdTargetsRelship"
    RELGQ_PST1 = "relgq_pst1"
    RELGQ_DHCP_P15_1 = "relgq_dhcp_P15_1"
    ...
    AGE_26_GROUPS = "age_26_groups"
    AGE_29_GROUPS = "age_29_groups"
    AGE_10_GROUPS = "age_10_groups"
    AGE_38_GROUPS = "age_38_groups"
    AGE_40_GROUPS = "age_40_groups"
    ...
    HHTYPE_MULTIG = "multig"
    COUPLED_HH_TYPE = "coupled_hh_type"
    DETAILED_COUPLE_TYPE_MULTG_CHILD_SIZE = "DetailedCoupleTypeMultGenOwnChildSize"
    DET_COUPLE_TYPE_MULTG_DET_CHILD_SIZE = "DetailedCoupleTypeMultGenDetOwnChildSize"
    DET_COUPLE_TYPE_DET_CHILD_SIZE = "DetailedCoupleTypeDetOwnChildSize"
    FAMILY_NONFAMILY_SIZE = "family_nonfamily_size"
    HHSIZE_ALL = "hhsize_all"
    PARTNER_TYPE_OWN_CHILD_STATUS = "partner_type_own_child_status"
    PARTNER_TYPE_DETAILED_OWN_CHILD_STATUS = "partner_type_detailed_own_child_status"
    POP_SEHSD_TARGET_UPART = "popSehsdTarget_upart"
    ...
    ## [gurobi stats]
    DEFAULT_GUROBI_STATISTICS_FILENAME = "$DAS_S3LOGS/$CLUSTERID/DAS/runs/$APPLICATIONID/GurobiStatistics"
    ...
    ###########################################
    READER = "reader"
    INPUT_DATA_VINTAGE = "input_data_vintage"
    PATH = "path"
    TABLES = "tables"
    TABLE_CLASS = "class"
    VARS = "variables"
    ...
    PHTABLE = "main_table"        # Person or Household Table
    ...
    BLOCK_OPTIMIZED_PATH = "block_optimized_path"
    PLB_DICT_PATH = "plb_dict_path"
    SAVE_READER_CHECKPOINTS = "save_reader_checkpoints"
    ...
    GRFC_PATH = "grfc_path"
    MAFX_PATH = "mafx_path"
    MAFX_GEO_COLS = "mafx_geo_cols"
    TABBLKSUFX1_NULL_VALUE = " "
    ...
    PARTS_AFTER_READING = "parts_after_reading"
    SKIP_PERSIST_IN_READER = "skip_persist_in_reader"
