...
class AgeAttr(AbstractAttribute):
    ...
    def recodeAgeEP():
        ...
        groups = {}
        for k in range(100):
            groups[str(k) + " years"] = [k]
        groups.update({"100+ years": list(range(100, 116))})
        return name, groups
    ...
    def recodeAge26groups():
        ...
        groupings = {
            ...
            '95 to 99 years': list(range(95, 100)), '100 to 104 years': list(range(100, 105)),
            '105 to 109 years': list(range(105, 110)), '110 to 115 years': list(range(110, 116)),
        }
    ...
    @staticmethod
    def recodeAge38groups():
        """
        Groups AGE into 38 buckets
        """
        name = CC.AGE_38_GROUPS
        groupings = {
            'Under 1 year': [0],
            '1 year'      : [1],
            '2 years'     : [2],
            ...
            '110 to 115 years': list(range(110, 116)),
        }
        return name, groupings

    @staticmethod
    def recodeAge40groups():
        """
        Groups AGE into 40 buckets
        """
        name = CC.AGE_40_GROUPS
        groupings = {
            'Under 1 year': [0],
            '1 year'      : [1],
            '2 years'     : [2],
    ...
    def recodeAge10groups():
        ...
        groupings = {
            ...
            '18 to 19 years': list(range(18, 20)), '20 to 24 years': list(range(20, 25)),
            '25 to 29 years': list(range(25, 30)), '30 to 34 years': list(range(30, 35)),
            '35 to 115 years': list(range(35, 116))}
        return name, groupings
    ...
    @staticmethod
    def recodeBinarysplit_agecats(maxage=115, splitlist=None):
        """
        ...
        if splitlist is None:
            splitlist = [116, 58, 29, 15, 7, 4, 2, 1]
    ...
    def recodeAge_greaterthan89():
        ...
        groupings = {"Age is >89": list(range(90, 116))}
        return name, groupings
    ...
    def recodeAge_gt74():
        ...
        groupings = {"Age is >74": list(range(75,116))}
        return name, groupings

    @staticmethod
    def recodeAge_lt15_gt89():
        name = CC.AGE_LT15_GT89_TOTAL
        groupings =  {"Age is <15 or >89": list(range(0, 15)) + list(range(90, 116))}
        return name, groupings

    @staticmethod
    def recodeAge_lt3_gt30():
        name = CC.AGE_LT3_GT30_TOTAL
        groupings =  {"Age is <3 or >30": list(range(0, 3)) + list(range(31, 116))}
        return name, groupings
    ...
    def recodeAge_gt20():
        ...
        groupings = {"Age is >20": list(range(21,116))}
        return name, groupings

    @staticmethod
    def recodeAge_lt16_gt75():
        name = CC.AGE_LT16_GT75_TOTAL
        groupings =  {"Age is <16 or >75": list(range(0, 16)) + list(range(76, 116))}
        return name, groupings
    ...
    def recodeAgeUpto100():
        ...
        """
        name = "ageupto100"
        groupings = {k: v for k, v in AgeAttr.getLevels().items() if v[0] < 100}
        groupings.update({'Over 100': list(range(100, 116))})
        return name, groupings
        # ('ageupto100',
        #  {'Under 1 year': [0],
        #   '1 year': [1],
        ...
        #   '98 years': [98],
        #   '99 years': [99],
        #   'Over 100': [100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115]})
    ...
    def recodeAgeAgePyramid23groups():
        ...
        groupings = {
            ...
            '80 to 84 years': list(range(80, 85)), '85 and over': list(range(85, 116))
        }
        return name, groupings
    ...
    def recodeAgecat100plus():
        ...
        groupings = {
                ...
                '99 years'    : [99],
                #'100 years'   : [100],
            "100 years and over": list(range(100,116))
    ...
    def recodeAgePopEst18groups():
        ...
        groupings = {
                     ...
                     '75 to 79 years': list(range(75,80)), '80 to 84 years': list(range(80,85)), '85 and over': list(range(85, 116))
}
        return name, groupings
    ...
    def recodeAgePopEst16plus():
        ...
        groupings = {'age 16 and over': list(range(16,116))}
        return name, groupings
    ...
    def recodeAge18_64_116():
        ...
        groupings = {'under 18 years': list(range(0,18)), '18 to 64 years':list(range(18,65)), '65 and over':list(range(65,116))}
        return name, groupings
    ...
    def recodeage18plus():
        ...
        name = CC.AGE_18PLUS
        groupings = {'18 and over': list(range(18,116))}
        return name, groupings
