...
NMF_READER_PATH = "<insert path to persons universe Redistricting Data File PR NMFs>"

SCHEMA = CC.SCHEMA_PL94
GEOLEVELS = ["State", "County", "Tract", "Block_Group", "Block"]

MARGINALIZE_QUERY = None  # "is65andover * relgq9cats_hhinst * sex * race7lev * hispanic"
...
TOTAL_INVARIANTS_GEOLEVELS = ["State"]
...
NMF_READER_PATH_RUN2 = "<insert path to DHCP PR NMFs>"
SCHEMA_RUN2 = CC.SCHEMA_DHCP

GEOLEVELS_RUN2 = ["State", "County", "Prim", "Tract_Subset_Group", "Tract_Subset", "Block_Group", "Block"]
...
# Options for est_cis(.):
CI_GEOLEVELS = ["State", "County", "Tract"]
...
##########
TABULATION_SPINE_GEODICT = {2: "State", 5: "County", 11: "Tract", 12:"Block_Group", 16: "Block"}
PARTITION_SIZE = 8
...
shuffle_partitions_dict_pl94 = {"State": 1, "County": 100, "Tract": 1000, "Block_Group": 3000, "Block": 10000}
shuffle_partitions_dict_dhc = {"State": 1, "County": 100, "Prim": 100, "Tract_Subset_Group": 100, "Tract_Subset": 1000, "Block_Group": 3000, "Block": 10000}
